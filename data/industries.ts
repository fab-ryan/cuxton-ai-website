...
export const industries: Industry[] = [
  {
    ...
    problem: {
      ...
      intro:
        "Financial institutions face mounting regulatory scrutiny, complex distributed ledgers, and strict privacy boundaries that prohibit sending customer or transaction data to external multi-tenant APIs.",
      challenges: [
    ...
    howItWorks: [
      {
        ...
        note: "Comprehensive review of compliance frameworks, data residency requirements, and legacy banking system interfaces.",
      },
      {
        phase: "Architecture & Sandbox",
        note: "Design air-gapped or private VPC topologies and validate deterministic model outputs on synthetic institutional data.",
      },
      {
        phase: "Deploy & Harden",
        note: "Deploy hardened microservices into your secure infrastructure with continuous audit logging and role-based access control.",
      },
      {
        phase: "Operate & Audit",
        note: "Continuous monitoring of latency, model drift, and audit trail integrity under formal change-management controls.",
      },
    ],
    typicalUseCases: [
  ...
  },
  {
    ...
    problem: {
      ...
      intro:
        "Healthcare systems generate massive volumes of clinical narratives, diagnostic records, and scientific papers, but strict privacy regulations and patient safety require absolute control over where and how data is processed.",
      challenges: [
    ...
    howItWorks: [
      {
        phase: "Clinical Governance Review",
        note: "Examine institutional review board (IRB) mandates, EHR integrations, and strict PHI isolation boundaries.",
      },
      {
        phase: "Zero-Retention Architecture",
        note: "Construct dedicated inference endpoints inside your certified healthcare enclave with deterministic retrieval.",
      },
      {
        phase: "EHR & System Integration",
        note: "Connect secure APIs to FHIR/HL7 feeds with real-time audit logging and clinician override controls.",
      },
      {
        phase: "Clinical Validation & Drift Control",
        note: "Continuous validation against peer-reviewed ground truth datasets with clinician oversight.",
      },
    ],
    typicalUseCases: [
  ...
  },
  {
    ...
    problem: {
      ...
      intro:
        "Public institutions cannot rely on foreign cloud infrastructure or proprietary closed models whose training data and data exfiltration paths cannot be independently verified.",
      challenges: [
    ...
    howItWorks: [
      {
        phase: "Threat Modeling & Clearance",
        note: "Establish security classification boundaries, physical facility constraints, and air-gap specifications.",
      },
      {
        phase: "Sovereign Enclave Build",
        note: "Provision on-premise GPU clusters, harden runtime environments, and load certified domestic models.",
      },
      {
        phase: "Policy Integration & Hardening",
        note: "Index national archives, statutory legal corpora, and administrative guidelines with strict lineage tracking.",
      },
      {
        phase: "Audited Deployment & Handoff",
        note: "Deliver full operational runbooks and train cleared personnel for 100% autonomous operation.",
      },
    ],
    typicalUseCases: [
    ...
    security: [
      ...
      "Compliance with federal standards including NIST SP 600-53 and FedRAMP High benchmarks",
  ...
  },
  {
    ...
    problem: {
      eyebrow:
        "Protect research breakthroughs without slowing scientific momentum.",
      intro:
        "Academic researchers risk intellectual property forfeiture by uploading proprietary grant findings and patent drafts to commercial AI platforms, while universities struggle to manage disparate student AI usage.",
      challenges: [
    ...
    howItWorks: [
      {
        phase: "Academic Workflow Audit",
        note: "Map faculty research data workflows, student management systems (SIS/LMS), and intellectual property guidelines.",
      },
      {
        phase: "Campus Sandbox Architecture",
        note: "Deploy dedicated on-campus or private cloud instances with single sign-on (SSO) and departmental tenancy.",
      },
      {
        phase: "Repository & Library Ingestion",
        note: "Index university libraries, research datasets, and course catalogues with attribution tracking.",
      },
      {
        phase: "Enablement & Scale",
        note: "Conduct faculty enablement workshops and implement quota controls to optimize campus compute utilization.",
      },
    ],
    typicalUseCases: [
    ...
    relatedSolutions: [
      ...
      {
        id: "automation",
        name: "Operational AI & Process Automation",
  ...
  },
  {
    ...
    problem: {
      eyebrow:
        "Carrier operations demand sub-second latency and five-nines reliability.",
      intro:
        "Telecom providers face skyrocketing traffic demands, complex multi-vendor network topologies, and razor-thin margins, where customer churn and network outages carry devastating costs.",
      challenges: [
    ...
    howItWorks: [
      {
        phase: "OSS/BSS & Telemetry Audit",
        note: "Evaluate network logging pipelines, streaming architectures (Kafka/Flink), and subscriber privacy boundaries.",
      },
      {
        phase: "Edge & Central Topology Build",
        note: "Construct distributed inference nodes optimized for low latency across edge and central data centers.",
      },
      {
        phase: "Model Fine-Tuning & Runbook Ingestion",
        note: "Fine-tune models on domain-specific telecom protocols, RFCs, and internal engineering runbooks.",
      },
      {
        phase: "Production Cutover & Monitoring",
        note: "Progressive traffic cutover with automated fallback and continuous telemetry performance auditing.",
      },
    ],
    typicalUseCases: [
  ...
  },
  {
    ...
    problem: {
      ...
      intro:
        "Legal and audit firms are bound by client-attorney privilege and strict professional confidentiality standards that prohibit pasting client documents into public cloud AI services.",
      challenges: [
    ...
    howItWorks: [
      {
        phase: "Matter & Privilege Audit",
        note: "Define ethical walls, client matter segregation rules, and document management system (DMS) integrations.",
      },
      {
        phase: "Isolated Enclave Setup",
        note: "Deploy dedicated single-tenant infrastructure with end-to-end encryption and zero persistent storage beyond client control.",
      },
      {
        phase: "Playbook & Precedent Ingestion",
        note: "Ingest standard firm contract templates, past deal bibles, and regulatory frameworks with attribution indexing.",
      },
      {
        phase: "Lawyer & Auditor Enablement",
        note: "Deliver firm-wide training on prompt craftsmanship, evidentiary verification, and ethical AI utilization.",
      },
    ],
    typicalUseCases: [
