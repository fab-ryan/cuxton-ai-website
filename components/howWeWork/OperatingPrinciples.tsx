  ...
  return (
    <svg viewBox="0 0 420 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(20, 20)">
        <text x="0" y="10" fill="var(--cuxton-teal-light)" fontSize="9" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">
        ...
        <text x="10" y="42" fill="var(--cuxton-amber)" fontSize="8" fontWeight="800" fontFamily="monospace">01 · INGESTION</text>
        ...
        <text x="148" y="42" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" fontFamily="monospace">02 · EVALUATION</text>
        ...
        <text x="296" y="42" fill="var(--cuxton-amber)" fontSize="8" fontWeight="800" fontFamily="monospace">03 · OUTCOME</text>
        ...
        <text x="14" y="146" fill="var(--cuxton-amber)" fontSize="12" fontWeight="850" fontFamily="monospace">0% (ZERO)</text>

        <text x="200" y="128" fill="var(--sch-text-dim)" fontSize="8.5" fontFamily="monospace">CLIENT INCENTIVE ALIGNMENT</text>
        <text x="200" y="146" fill="var(--cuxton-teal-light)" fontSize="12" fontWeight="850" fontFamily="monospace">100% UNBIASED</text>
      </g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 420 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(20, 20)">
        ...
        <text x="180" y="41" fill="var(--cuxton-teal-light)" fontSize="9.5" fontWeight="800" fontFamily="monospace">94% PASS</text>
        ...
        <text x="180" y="73" fill="#10b981" fontSize="9.5" fontWeight="800" fontFamily="monospace">100% CLEAR</text>
        ...
        <text x="180" y="105" fill="var(--cuxton-teal-light)" fontSize="9.5" fontWeight="800" fontFamily="monospace">91% PASS</text>
        ...
        <text x="180" y="137" fill="var(--cuxton-amber)" fontSize="9.5" fontWeight="800" fontFamily="monospace">8-MONTH</text>
        ...
        <text x="257" y="44" fill="var(--cuxton-amber)" fontSize="8.5" fontWeight="800" fontFamily="monospace">CAPITAL PROTECTION</text>
        <text x="257" y="66" fill="var(--sch-text)" fontSize="11" fontWeight="800" fontFamily="sans-serif">Zero Sunk Costs</text>
        ...
        <text x="312" y="124" fill="var(--cuxton-teal-light)" fontSize="8.5" fontWeight="800" textAnchor="middle" fontFamily="monospace">NO FALSE CLAIMS</text>
      </g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 420 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(20, 20)">
        ...
        <text x="54" y="72" fill="var(--cuxton-amber)" fontSize="9.5" fontWeight="800" fontFamily="monospace">CUXTON CONTROLLED PILOT PERIMETER</text>
        ...
        <g transform="translate(54, 82)">
          ...
          <text x="8" y="18" fill="var(--cuxton-teal-light)" fontSize="7.5" fontWeight="800" fontFamily="monospace">WEEKS 1–2</text>
          ...
          <text x="103" y="18" fill="var(--cuxton-teal-light)" fontSize="7.5" fontWeight="800" fontFamily="monospace">WEEKS 3–6</text>
          ...
          <text x="202" y="18" fill="var(--cuxton-amber)" fontSize="7.5" fontWeight="800" fontFamily="monospace">WEEKS 7–8</text>
  ...
  return (
    <svg viewBox="0 0 420 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(20, 20)">
        ...
        <text x="10" y="42" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" fontFamily="monospace">AI INFERENCE LAYER</text>
        ...
        <text x="10" y="126" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" fontFamily="monospace">RECOMMENDATION ONLY</text>
        ...
        <text x="185" y="42" fill="var(--cuxton-amber)" fontSize="8" fontWeight="800" fontFamily="monospace">HUMAN OPERATOR GATE</text>
        ...
        <text x="185" y="126" fill="var(--cuxton-amber)" fontSize="8" fontWeight="800" fontFamily="monospace">AUTHORITY REQUIRED</text>
        ...
        <text x="352" y="78" fill="#10b981" fontSize="8" fontWeight="800" fontFamily="monospace">ACTION</text>
  ...
  return (
    <svg viewBox="0 0 420 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(20, 20)">
        ...
        <text x="12" y="44" fill="#ef4444" fontSize="8.5" fontWeight="800" fontFamily="monospace">REJECTED OVERHEAD</text>
        ...
        <text x="90" y="134" fill="#ef4444" fontSize="7.5" fontWeight="800" textAnchor="middle" fontFamily="monospace">UNNECESSARY COMPLEXITY</text>
        ...
        <text x="212" y="44" fill="var(--cuxton-teal-light)" fontSize="8.5" fontWeight="800" fontFamily="monospace">CUXTON LEAN ARCHITECTURE</text>
        ...
        <text x="290" y="134" fill="#10b981" fontSize="7.5" fontWeight="800" textAnchor="middle" fontFamily="monospace">PROPORTIONAL &amp; RELIABLE</text>
      </g>
    </svg>
  );
}
...
function LongTermThinkingGraphic() {
  return (
    <svg viewBox="0 0 420 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(20, 20)">
        <text x="0" y="10" fill="var(--cuxton-teal-light)" fontSize="9" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">
          SOVEREIGN ASSET CUSTODY &amp; DRIFT MONITORING
        </text>
        ...
        <g transform="translate(0, 26)">
          ...
          <text x="10" y="20" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" fontFamily="monospace">01 · IP ASSET</text>
          ...
          <text x="60" y="102" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" textAnchor="middle" fontFamily="monospace">OWNERSHIP</text>
        </g>
        ...
        <g transform="translate(130, 26)">
          ...
          <text x="10" y="20" fill="var(--cuxton-amber)" fontSize="8" fontWeight="800" fontFamily="monospace">02 · HANDOVER</text>
          ...
          <text x="60" y="102" fill="var(--cuxton-amber)" fontSize="8" fontWeight="800" textAnchor="middle" fontFamily="monospace">AUTONOMY</text>
        </g>

        <g transform="translate(260, 26)">
          <rect x="0" y="0" width="120" height="118" rx="6" fill="var(--sch-panel)" stroke="#10b981" strokeWidth="1" />
          <text x="10" y="20" fill="#10b981" fontSize="8" fontWeight="800" fontFamily="monospace">03 · VIGILANCE</text>
          ...
          <text x="60" y="102" fill="#10b981" fontSize="8" fontWeight="800" textAnchor="middle" fontFamily="monospace">RESILIENCE</text>
        </g>
      </g>
    </svg>
  );
...
const PRINCIPLES_DATA: PrincipleData[] = [
  ...
  },
  {
    ...
    graphicTitle: "Sovereign Custody & Drift Horizon",
      ...
      <div className="section-container relative z-10">
        ...
        <header className={styles.header}>
          ...
          <p className={styles.lead}>
            Our six institutional tenets govern our engineering decisions, feasibility assessments, and operational partnerships ensuring every deployment remains accountable, transparent, and sovereign.
          </p>
        </header>
          ...
          <div className={styles.navPillsRow} role="tablist" aria-label="Operating Principles Slides">
            {PRINCIPLES_DATA.map((p, idx) => {
              ...
              return (
                ...
                >
                  <span className={styles.pillNum}>{p.index}</span>
          ...
          <div className={styles.stageGrid}>
            ...
            <div className={styles.slideNarrativeCol}>
              <div className={styles.slideMetaHeader}>
                <span className={styles.slideIndexBadge}>TENET {activePrinciple.index} / 06</span>
              ...
              <div className={styles.stageFooterRow}>
                <div className={styles.statusIndicator}>
                  ...
                  <span>NON-NEGOTIABLE TENET</span>
                </div>
              ...
              return (
                ...
                >
                  <div className={styles.gridCardTop}>
                    <span className={styles.gridCardNum}>TENET {p.index}</span>
