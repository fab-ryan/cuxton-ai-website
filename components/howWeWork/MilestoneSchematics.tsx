  ...
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(20, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">INPUT CHANNELS</text>
      ...
      <g transform="translate(260, 30)">
        ...
        <text x="12" y="16" fill="var(--cuxton-amber)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">FRICTION DIAGNOSTIC ENGINE</text>
      ...
      <g transform="translate(540, 26)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">VERIFIED ASSET</text>
        <rect x="0" y="8" width="180" height="126" rx="8" fill="var(--sch-panel)" stroke="rgba(245,166,35,0.4)" strokeWidth="1.5" />
        <text x="14" y="30" fill="var(--cuxton-amber)" fontSize="12" fontWeight="800" fontFamily="sans-serif">AI Opportunity Catalog</text>
  ...
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(30, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">FEASIBILITY RADAR</text>
      ...
      <g transform="translate(290, 24)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">SIX-PILLAR STRESS TESTING</text>
      ...
      <g transform="translate(580, 24)">
        <text x="0" y="0" fill="var(--cuxton-amber)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">RISK AUDIT CLEARANCE</text>
        ...
        <text x="70" y="38" fill="var(--cuxton-teal-light)" fontSize="9.5" fontWeight="800" textAnchor="middle" fontFamily="monospace">ZERO BLOCKERS</text>
        
        <text x="14" y="66" fill="var(--sch-text)" fontSize="11" fontWeight="700" fontFamily="sans-serif">Feasibility Score</text>
        <text x="14" y="86" fill="var(--cuxton-amber)" fontSize="18" fontWeight="850" fontFamily="monospace">92.4 / 100</text>
  ...
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(40, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">VALUE VS. COMPLEXITY DECISION QUADRANT</text>
        ...
        <text x="280" y="34" fill="var(--cuxton-amber)" fontSize="8.5" fontWeight="800" textAnchor="middle" fontFamily="monospace">HIGH IMPACT / HIGH FEASIBILITY</text>
        ...
        <text x="280" y="69" fill="var(--sch-text)" fontSize="9" fontWeight="800" textAnchor="middle" fontFamily="sans-serif">PILOT SELECTION: USE CASE #1</text>
      </g>

      {/* Prioritization Decision Card (Right) */}
      <g transform="translate(440, 24)">
        <text x="0" y="0" fill="var(--cuxton-amber)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">PILOT PROJECT CHARTER</text>
        <rect x="0" y="10" width="260" height="126" rx="8" fill="var(--sch-panel)" stroke="rgba(245,166,35,0.4)" strokeWidth="1.5" />
        
        <text x="16" y="32" fill="var(--sch-text)" fontSize="12" fontWeight="850" fontFamily="sans-serif">Charter Scope Boundary</text>
        ...
        <text x="16" y="116" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" fontFamily="monospace">STATUS: RESOURCE ALLOCATED</text>
      </g>
    </svg>
  );
}
...
export function DesignSchematic() {
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(30, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">ZERO-TRUST SYSTEM ARCHITECTURE SPECIFICATION</text>
      </g>
      ...
      <g transform="translate(30, 42)">
        ...
        <text x="10" y="15" fill="var(--cuxton-amber)" fontSize="9" fontWeight="800" fontFamily="monospace">01 · INGESTION</text>
        ...
        <text x="190" y="15" fill="var(--cuxton-amber)" fontSize="9" fontWeight="800" fontFamily="monospace">02 · PERMISSIONS</text>
        ...
        <text x="370" y="15" fill="var(--cuxton-amber)" fontSize="9" fontWeight="800" fontFamily="monospace">03 · INFERENCE</text>
        ...
        <text x="550" y="15" fill="var(--cuxton-amber)" fontSize="9" fontWeight="800" fontFamily="monospace">04 · AUDIT VAULT</text>
...
export function PrototypeSchematic() {
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(30, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">CONTROLLED AIR-GAPPED PROTOTYPE LAB</text>
        ...
        <text x="14" y="32" fill="var(--cuxton-amber)" fontSize="10" fontWeight="800" fontFamily="monospace">AIR-GAPPED BENCHMARK SANDBOX</text>
        ...
        <text x="24" y="86" fill="var(--cuxton-teal-light)" fontSize="20" fontWeight="850" fontFamily="monospace">142 ms</text>
        ...
        <text x="160" y="86" fill="var(--cuxton-amber)" fontSize="20" fontWeight="850" fontFamily="monospace">99.2%</text>
        ...
        <text x="300" y="86" fill="var(--cuxton-teal-light)" fontSize="20" fontWeight="850" fontFamily="monospace">&lt; 0.05%</text>
      ...
      <g transform="translate(500, 24)">
        <text x="0" y="0" fill="var(--cuxton-amber)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">USER TESTING RESULTS</text>
        <rect x="0" y="10" width="200" height="126" rx="8" fill="var(--sch-panel)" stroke="rgba(245,166,35,0.4)" strokeWidth="1.5" />
        
        <text x="14" y="32" fill="var(--sch-text)" fontSize="11.5" fontWeight="800" fontFamily="sans-serif">End-User Usability Score</text>
        <text x="14" y="56" fill="var(--cuxton-teal-light)" fontSize="22" fontWeight="850" fontFamily="monospace">94.8%</text>
        ...
        <text x="14" y="122" fill="var(--cuxton-amber)" fontSize="9.5" fontWeight="800" fontFamily="monospace">READY FOR PRODUCTION BUILD</text>
      </g>
    </svg>
  );
}
...
export function DeploySchematic() {
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(30, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">DEDICATED CLIENT TENANT INFRASTRUCTURE</text>
        ...
        <text x="10" y="26" fill="var(--cuxton-amber)" fontSize="8.5" fontWeight="800" fontFamily="monospace">SECURE ENCLAVE BOUNDARY</text>

        {/* Core Components inside Tenant */}
        {/* Component 1 */}
        <g transform="translate(18, 42)">
          <rect x="0" y="0" width="130" height="82" rx="6" fill="var(--sch-panel)" stroke="rgba(27,107,138,0.4)" />
          <text x="10" y="18" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" fontFamily="monospace">API GATEWAY</text>
        ...
        <g transform="translate(180, 42)">
          ...
          <text x="10" y="18" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" fontFamily="monospace">CONTAINER CLUSTER</text>
        ...
        <g transform="translate(352, 42)">
          ...
          <text x="10" y="18" fill="var(--cuxton-amber)" fontSize="8" fontWeight="800" fontFamily="monospace">INFRASTRUCTURE SEC</text>
        ...
        <g transform="translate(524, 42)">
          ...
          <text x="10" y="18" fill="var(--cuxton-teal-light)" fontSize="8" fontWeight="800" fontFamily="monospace">RUNBOOKS &amp; SRE</text>
...
export function EnableSchematic() {
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(30, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">WORKFORCE ENABLEMENT &amp; CUSTODY MATRIX</text>
        ...
        <g transform="translate(0, 16)">
          ...
          <text x="12" y="15" fill="var(--cuxton-amber)" fontSize="8.5" fontWeight="800" fontFamily="monospace">TRACK 01 · OPERATORS</text>
          ...
          <text x="105" y="103" fill="var(--cuxton-teal-light)" fontSize="9" fontWeight="800" textAnchor="middle" fontFamily="monospace">100% OPERATORS CERTIFIED</text>
        </g>
        ...
        <g transform="translate(235, 16)">
          ...
          <text x="12" y="15" fill="var(--cuxton-amber)" fontSize="8.5" fontWeight="800" fontFamily="monospace">TRACK 02 · SYSTEM ADMINS</text>
          ...
          <rect x="12" y="90" width="186" height="18" rx="4" fill="var(--sch-deep)" />
          <text x="105" y="103" fill="var(--cuxton-amber)" fontSize="9" fontWeight="800" textAnchor="middle" fontFamily="monospace">ADMIN DRILL PASSED</text>
        </g>
        ...
        <g transform="translate(470, 16)">
          <rect x="0" y="0" width="210" height="120" rx="8" fill="var(--sch-panel)" stroke="var(--cuxton-teal-light)" strokeWidth="1.2" />
          <rect x="0" y="0" width="210" height="22" rx="8" fill="var(--sch-line)" />
          <text x="12" y="15" fill="var(--cuxton-amber)" fontSize="8.5" fontWeight="800" fontFamily="monospace">TRACK 03 · LEADERSHIP</text>
          ...
          <rect x="12" y="90" width="186" height="18" rx="4" fill="var(--sch-deep)" />
          <text x="105" y="103" fill="var(--cuxton-teal-light)" fontSize="9" fontWeight="800" textAnchor="middle" fontFamily="monospace">GOVERNANCE CODIFIED</text>
        </g>
      </g>
    </svg>
  );
...
export function OperateSchematic() {
  return (
    <svg viewBox="0 0 740 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <g transform="translate(30, 20)">
        <text x="0" y="0" fill="var(--cuxton-teal-light)" fontSize="10" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">CONTINUOUS OBSERVABILITY &amp; DRIFT TELEMETRY</text>
        ...
        <g transform="translate(0, 16)">
          ...
          <text x="20" y="44" fill="var(--sch-text)" fontSize="16" fontWeight="850" fontFamily="monospace">99.98%</text>

          <text x="160" y="24" fill="var(--sch-text-dim)" fontSize="8.5" fontFamily="monospace">DATA DRIFT VARIANCE</text>
          <text x="160" y="44" fill="#10b981" fontSize="16" fontWeight="850" fontFamily="monospace">0.02% (NOMINAL)</text>

          <text x="310" y="24" fill="var(--sch-text-dim)" fontSize="8.5" fontFamily="monospace">AUTOMATED RETRAIN</text>
          <text x="310" y="44" fill="var(--cuxton-amber)" fontSize="16" fontWeight="850" fontFamily="monospace">ACTIVE BOUND</text>
        ...
        <g transform="translate(435, 16)">
          ...
          <text x="14" y="24" fill="var(--cuxton-amber)" fontSize="9" fontWeight="800" letterSpacing="0.1em" fontFamily="monospace">QUARTERLY EXPANSION HORIZON</text>
          
          <text x="14" y="46" fill="var(--sch-text)" fontSize="12" fontWeight="800" fontFamily="sans-serif">Value Scale Roadmap</text>
          ...
          <text x="122" y="106" fill="var(--cuxton-teal-light)" fontSize="8.5" fontWeight="800" textAnchor="middle" fontFamily="monospace">ENTERPRISE SCALE CERTIFIED</text>
        </g>
      </g>
    </svg>
  );
...
export function TopologyRadarDeck({ activeStepIndex }: { activeStepIndex: number }) {
  ...
  return (
    <svg viewBox="0 0 260 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <text x={centerX} y="168" fill="var(--cuxton-amber)" fontSize="8.5" fontWeight="800" textAnchor="middle" fontFamily="monospace">
        ACTIVE NODE: {steps[activeStepIndex].n} · {steps[activeStepIndex].name.toUpperCase()}
      </text>
    </svg>
  );
}
